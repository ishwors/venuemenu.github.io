								      			...
								      			if(mysqli_num_rows($query_run) > 0) {
								      				foreach($query_run as $row) {
								      					...
								      					<div class="form-group">
												        	...
												        	<input type="text" id="event_date" name="event_date" value="<?php echo $row['event_date']; ?>" class="form-control" placeholder="Event Date" autocomplete="off">
												        </div>
								      					<div class="form-group">
												        	<label for="start_time">Start Time</label>
												        	<input type="text" id="start_time" name="start_time" value="<?php echo $row['start_time']; ?>" class="form-control" placeholder="Start Time" autocomplete="off">
												        </div>
												        <div class="form-group">
												        	<label for="end_time">End Time</label>
												        	<input type="text" id="end_time" name="end_time" value="<?php echo $row['end_time']; ?>" class="form-control" placeholder="End Time" autocomplete="off">
												        </div>
												        <div class="form-group">
												        	<label for="event_type">Event Type</label>
												        	<input type="text" id="event_type" name="event_type" value="<?php echo $row['event_type']; ?>" class="form-control" placeholder="Event Type" autocomplete="off">
												        </div>
												        <div class="form-group">
