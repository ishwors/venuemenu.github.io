    ...
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <?php
                        $query = "SELECT CONCAT(firstname, ' ', lastname) AS name, event_type, event_date, start_time, end_time, event_status, event_id FROM users, events WHERE users.id = events.user_id AND NOT event_status IN ('Accepted', 'Rejected') ORDER BY event_date DESC";
                        $query_run = mysqli_query($conn, $query);
