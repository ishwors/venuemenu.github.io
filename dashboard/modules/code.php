...
if(isset($_POST['updateEvent'])) {
	...
	$query = "UPDATE events SET event_type='$event_type', event_date='$event_date', start_time='$start_time', end_time='$end_time', event_status='$event_status' WHERE event_id='$event_id' ";
	$query_run = mysqli_query($conn, $query);
