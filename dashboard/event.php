                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                        $query = "SELECT event_type, CONCAT(firstname, ' ', lastname) AS name, event_date, start_time, end_time, event_status, event_id FROM users, events WHERE users.id = events.user_id ORDER BY event_date DESC;";
